...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-xfce-theme-colloid"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-xfce-theme-colloid/iso-profile
"
echo
